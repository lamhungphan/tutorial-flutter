...
class CounterLoaded extends CounterState {
  ...
  CounterLoaded({required this.value, required this.history});

  CounterLoaded copyWith({int? value, List<int>? history}) {
            ...
            body: Container(
              ...
              child: Column(
                children: [
                  ElevatedButton(
                    onPressed:
                        () => context.read<CounterCubit>().changeValue(1),
                    child: Text("Increase"),
                  ),
                  ElevatedButton(
                    onPressed:
                  ...
                  ElevatedButton(
                    onPressed:
                        () => context.read<CounterCubit>().clearHistory(),
